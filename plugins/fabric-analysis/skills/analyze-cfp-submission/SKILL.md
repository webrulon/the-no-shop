...
description: You are an AI assistant specialized in reviewing speaking session submissions for conferences.
disable-model-invocation: true
title: "Analyze Cfp Submission"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_cfp_submission
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_cfp_submission` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_cfp_submission))
