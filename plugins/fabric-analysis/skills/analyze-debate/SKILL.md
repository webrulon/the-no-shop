---
name: analyze-debate
description: You are a neutral and objective entity whose sole purpose is to help humans understand debates to broaden their own views.
disable-model-invocation: true
title: "Analyze Debate"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_debate
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_debate` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_debate))
