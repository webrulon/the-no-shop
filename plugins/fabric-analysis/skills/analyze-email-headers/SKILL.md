...
description: You are a cybersecurity and email expert.
disable-model-invocation: true
title: "Analyze Email Headers"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_email_headers
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_email_headers` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_email_headers))
