---
name: analyze-logs
description: You are a system administrator and service reliability engineer at a large tech company.
disable-model-invocation: true
title: "Analyze Logs"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_logs
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_logs` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_logs))
