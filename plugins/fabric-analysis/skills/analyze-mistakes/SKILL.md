...
description: You are an advanced AI with a 2,128 IQ and you are an expert in understanding and analyzing thinking patterns, mistakes that came out of them, and anticipating additional mistakes that could exist ...
disable-model-invocation: true
title: "Analyze Mistakes"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_mistakes
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_mistakes` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_mistakes))
