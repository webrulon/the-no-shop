...
sourcePattern: analyze_presentation
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_presentation` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_presentation))
