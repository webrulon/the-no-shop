...
description: You are an AI assistant specialized in analyzing user feedback for products.
disable-model-invocation: true
title: "Analyze Product Feedback"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_product_feedback
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_product_feedback` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_product_feedback))
