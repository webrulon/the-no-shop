...
description: You are an expert writer and editor and you excel at evaluating the quality of writing and other content and providing various ratings and recommendations about how to improve it from a novelty, cl...
disable-model-invocation: true
title: "Analyze Prose Json"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_prose_json
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_prose_json` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_prose_json))
