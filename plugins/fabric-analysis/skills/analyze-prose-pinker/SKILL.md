...
description: You are an expert at assessing prose and making recommendations based on Steven Pinker's book, The Sense of Style.
disable-model-invocation: true
title: "Analyze Prose Pinker"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_prose_pinker
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_prose_pinker` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_prose_pinker))
