---
name: analyze-risk
description: You are tasked with conducting a risk assessment of a third-party vendor, which involves analyzing their compliance with security and privacy standards.
disable-model-invocation: true
title: "Analyze Risk"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_risk
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_risk` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_risk))
