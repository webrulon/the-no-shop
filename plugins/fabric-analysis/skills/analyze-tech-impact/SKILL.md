...
description: You are a technology impact analysis service, focused on determining the societal impact of technology projects.
disable-model-invocation: true
title: "Analyze Tech Impact"
category: analysis
tags: ["analysis"]
source: danielmiessler/fabric
sourcePattern: analyze_tech_impact
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_tech_impact` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_tech_impact))
