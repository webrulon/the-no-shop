...
sourcePattern: analyze_threat_report
license: MIT
version: "1.0"
---
...
- **Pattern**: `analyze_threat_report` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/analyze_threat_report))
