---
name: create-bd-issue
description: You are an expert at transforming natural language issue descriptions into optimal `bd create` commands.
disable-model-invocation: true
title: "Create Bd Issue"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_bd_issue
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_bd_issue` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_bd_issue))
