---
name: create-better-frame
description: You are an expert at finding better, positive mental frames for seeing the world as described in the ESSAY below.
disable-model-invocation: true
title: "Create Better Frame"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_better_frame
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_better_frame` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_better_frame))
