...
description: You are an intelligent assistant specialized in **knowledge visualization and educational data structuring**.
disable-model-invocation: true
title: "Create Conceptmap"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_conceptmap
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_conceptmap` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_conceptmap))
