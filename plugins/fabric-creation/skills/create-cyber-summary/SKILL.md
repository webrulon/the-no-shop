...
sourcePattern: create_cyber_summary
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_cyber_summary` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_cyber_summary))
