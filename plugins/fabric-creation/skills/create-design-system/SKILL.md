...
description: You are an expert design systems architect.
disable-model-invocation: true
title: "Create Design System"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_design_system
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_design_system` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_design_system))
