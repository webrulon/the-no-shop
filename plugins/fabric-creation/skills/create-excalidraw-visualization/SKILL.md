...
description: Fabric pattern: create_excalidraw_visualization
disable-model-invocation: true
title: "Create Excalidraw Visualization"
category: creation
tags: ["creation", "excalidraw", "visualization"]
source: danielmiessler/fabric
sourcePattern: create_excalidraw_visualization
license: MIT
version: "1.0"
---
...
This skill outputs Excalidraw JSON. To use:
- Paste into Excalidraw (https://excalidraw.com) via import
- Or save as .excalidraw file and open in the desktop app

## Attribution

- **Source**: [danielmiessler/fabric](https://github.com/danielmiessler/fabric)
- **Pattern**: `create_excalidraw_visualization` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_excalidraw_visualization))
