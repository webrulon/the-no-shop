---
name: create-golden-rules
description: You are an expert at extracting implicit rules and guidelines from codebases, documentation, or team practices.
disable-model-invocation: true
title: "Create Golden Rules"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_golden_rules
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_golden_rules` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_golden_rules))
