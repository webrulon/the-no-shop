...
description: Fabric pattern: create_investigation_visualization
disable-model-invocation: true
title: "Create Investigation Visualization"
category: creation
tags: ["creation", "graphviz", "visualization"]
source: danielmiessler/fabric
sourcePattern: create_investigation_visualization
license: MIT
version: "1.0"
---
...
This skill outputs GraphViz/DOT syntax. To render:
- `dot -Tsvg input.dot -o output.svg` (requires graphviz: `brew install graphviz`)
- Or paste into an online GraphViz viewer

## Attribution

- **Source**: [danielmiessler/fabric](https://github.com/danielmiessler/fabric)
- **Pattern**: `create_investigation_visualization` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_investigation_visualization))
