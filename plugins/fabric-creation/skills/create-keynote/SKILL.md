---
name: create-keynote
description: You are an expert at creating TED-quality keynote presentations from the input provided.
disable-model-invocation: true
title: "Create Keynote"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_keynote
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_keynote` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_keynote))
