...
description: You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using MarkMap.
disable-model-invocation: true
title: "Create Markmap Visualization"
category: creation
tags: ["creation", "markmap", "visualization"]
source: danielmiessler/fabric
sourcePattern: create_markmap_visualization
license: MIT
version: "1.0"
---
...
This skill outputs MarkMap syntax. To render:
- Use the MarkMap VS Code extension
- Or `npx markmap-cli input.md -o output.html`
- Or paste into https://markmap.js.org/repl

## Attribution

- **Source**: [danielmiessler/fabric](https://github.com/danielmiessler/fabric)
- **Pattern**: `create_markmap_visualization` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_markmap_visualization))
