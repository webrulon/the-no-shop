---
name: create-mermaid-visualization-for-github
description: You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using Mermaid (markdown) syntax.
disable-model-invocation: true
title: "Create Mermaid Visualization For Github"
category: creation
tags: ["creation", "mermaid", "visualization"]
source: danielmiessler/fabric
sourcePattern: create_mermaid_visualization_for_github
license: MIT
version: "1.0"
---
...
This skill outputs Mermaid diagram syntax. To render:
- Paste into any Mermaid-compatible viewer (GitHub markdown, Mermaid Live Editor, VS Code plugin)
- Or render to image: `npx @mermaid-js/mermaid-cli -i input.mmd -o output.svg`

## Attribution

- **Source**: [danielmiessler/fabric](https://github.com/danielmiessler/fabric)
- **Pattern**: `create_mermaid_visualization_for_github` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_mermaid_visualization_for_github))
