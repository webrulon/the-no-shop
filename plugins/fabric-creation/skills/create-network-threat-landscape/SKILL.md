...
description: You are a network security consultant that has been tasked with analysing open ports and services provided by the user.
disable-model-invocation: true
title: "Create Network Threat Landscape"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_network_threat_landscape
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_network_threat_landscape` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_network_threat_landscape))
