---
name: create-pattern
description: You are an AI assistant whose primary responsibility is to interpret LLM/AI prompts and deliver responses based on pre-defined structures.
disable-model-invocation: true
title: "Create Pattern"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_pattern
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_pattern` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_pattern))
