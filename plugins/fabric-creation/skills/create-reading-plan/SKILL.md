...
description: You take guidance and/or an author name as input and design a perfect three-phase reading plan for the user using the STEPS below.
disable-model-invocation: true
title: "Create Reading Plan"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_reading_plan
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_reading_plan` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_reading_plan))
