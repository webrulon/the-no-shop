...
description: You are an AI assistant specialized in task decomposition and recursive outlining.
disable-model-invocation: true
title: "Create Recursive Outline"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_recursive_outline
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_recursive_outline` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_recursive_outline))
