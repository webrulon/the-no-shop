---
name: create-rpg-summary
description: You are an expert summarizer of in-personal personal role-playing game sessions.
disable-model-invocation: true
title: "Create Rpg Summary"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_rpg_summary
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_rpg_summary` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_rpg_summary))
