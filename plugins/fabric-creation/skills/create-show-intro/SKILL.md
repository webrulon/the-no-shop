...
description: You are an expert podcast and media producer specializing in creating the most compelling and interesting short intros that are read before the start of a show.
disable-model-invocation: true
title: "Create Show Intro"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_show_intro
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_show_intro` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_show_intro))
