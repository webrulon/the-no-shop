...
description: Fabric pattern: create_sigma_rules
disable-model-invocation: true
allowed-tools: Bash(sigma *)
title: "Create Sigma Rules"
category: creation
tags: ["creation", "sigma"]
source: danielmiessler/fabric
sourcePattern: create_sigma_rules
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_sigma_rules` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_sigma_rules))
