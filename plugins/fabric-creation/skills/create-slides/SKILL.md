---
name: create-slides
description: You are an expert communicator, capable of explaining and visualizing complex concepts, conveying even the most complex narratives in the form of an engaging, well-structured presentation.
disable-model-invocation: true
title: "Create Slides"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_slides
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_slides` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_slides))
