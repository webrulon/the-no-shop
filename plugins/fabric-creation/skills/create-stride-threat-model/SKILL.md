...
description: You are an expert in risk and threat management and cybersecurity.
disable-model-invocation: true
title: "Create Stride Threat Model"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_stride_threat_model
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_stride_threat_model` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_stride_threat_model))
