...
sourcePattern: create_threat_scenarios
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_threat_scenarios` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_threat_scenarios))
