...
description: You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using ASCII art.
disable-model-invocation: true
title: "Create Visualization"
category: creation
tags: ["creation"]
source: danielmiessler/fabric
sourcePattern: create_visualization
license: MIT
version: "1.0"
---
...
- **Pattern**: `create_visualization` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/create_visualization))
