---
name: extract-all-quotes
description: You are an expert at extracting all of the inspirational, educational quotes and aphorisms from Founders or notable individuals quoted in their biographies, from a given transcript such a from a po...
...
sourcePattern: extract_all_quotes
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_all_quotes` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_all_quotes))
