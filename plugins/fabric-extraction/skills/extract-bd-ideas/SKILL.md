---
name: extract-bd-ideas
description: You are an expert at extracting actionable ideas from content and transforming them into well-structured issue tracker commands.
disable-model-invocation: true
title: "Extract Bd Ideas"
category: extraction
tags: ["extraction"]
source: danielmiessler/fabric
sourcePattern: extract_bd_ideas
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_bd_ideas` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_bd_ideas))
