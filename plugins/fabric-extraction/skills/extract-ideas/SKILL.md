---
name: extract-ideas
description: You are an advanced AI with a 2,128 IQ and you are an expert in understanding any input and extracting the most important ideas from it.
disable-model-invocation: true
title: "Extract Ideas"
category: extraction
tags: ["extraction"]
source: danielmiessler/fabric
sourcePattern: extract_ideas
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_ideas` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_ideas))
