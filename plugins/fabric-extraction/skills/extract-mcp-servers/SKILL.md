...
description: You are an expert at analyzing content related to MCP (Model Context Protocol) servers.
disable-model-invocation: true
title: "Extract Mcp Servers"
category: extraction
tags: ["extraction"]
source: danielmiessler/fabric
sourcePattern: extract_mcp_servers
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_mcp_servers` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_mcp_servers))
