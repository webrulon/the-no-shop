...
description: You take a collection of ideas or data or observations and you look for the most interesting and surprising patterns.
disable-model-invocation: true
title: "Extract Patterns"
category: extraction
tags: ["extraction"]
source: danielmiessler/fabric
sourcePattern: extract_patterns
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_patterns` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_patterns))
