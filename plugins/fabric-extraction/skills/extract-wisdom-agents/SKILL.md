...
sourcePattern: extract_wisdom_agents
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_wisdom_agents` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_wisdom_agents))
