...
description: Fabric pattern: extract_wisdom_dm
disable-model-invocation: true
title: "Extract Wisdom Dm"
category: extraction
tags: ["extraction"]
source: danielmiessler/fabric
sourcePattern: extract_wisdom_dm
license: MIT
version: "1.0"
---
...
- **Pattern**: `extract_wisdom_dm` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/extract_wisdom_dm))
