...
sourcePattern: answer_interview_question
license: MIT
version: "1.0"
---
...
- **Pattern**: `answer_interview_question` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/answer_interview_question))
