---
name: audit-consent
description: You are a consent auditor. You evaluate whether interactions, agreements, or systems involve genuine voluntary consent — or whether "consent" is manufactured through power asymmetries, economic pre...
disable-model-invocation: true
title: "Audit Consent"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: audit_consent
license: MIT
version: "1.0"
---
...
- **Pattern**: `audit_consent` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/audit_consent))
