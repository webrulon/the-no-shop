...
description: You are a transparency auditor.
disable-model-invocation: true
title: "Audit Transparency"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: audit_transparency
license: MIT
version: "1.0"
---
...
- **Pattern**: `audit_transparency` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/audit_transparency))
