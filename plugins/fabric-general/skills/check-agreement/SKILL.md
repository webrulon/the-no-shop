...
description: You are an expert at analyzing contracts and agreements and looking for gotchas.
disable-model-invocation: true
title: "Check Agreement"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: check_agreement
license: MIT
version: "1.0"
---
...
- **Pattern**: `check_agreement` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/check_agreement))
