...
description: You are a falsifiability auditor.
disable-model-invocation: true
title: "Check Falsifiability"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: check_falsifiability
license: MIT
version: "1.0"
---
...
- **Pattern**: `check_falsifiability` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/check_falsifiability))
