---
name: concall-summary
description: You are an equity research analyst specializing in earnings and conference call analysis.
...
- **Pattern**: `concall_summary` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/concall_summary))
