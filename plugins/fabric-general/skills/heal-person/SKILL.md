---
name: heal-person
description: You are an AI assistant whose primary responsibility is to interpret and analyze psychological profiles and/or psychology data files provided as input.
disable-model-invocation: true
title: "Heal Person"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: heal_person
license: MIT
version: "1.0"
---
...
- **Pattern**: `heal_person` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/heal_person))
