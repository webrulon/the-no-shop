...
description: You are an all-knowing psychiatrist, psychologist, and life coach and you provide honest and concise advice to people based on the question asked combined with the context provided.
disable-model-invocation: true
title: "Provide Guidance"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: provide_guidance
license: MIT
version: "1.0"
---
...
- **Pattern**: `provide_guidance` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/provide_guidance))
