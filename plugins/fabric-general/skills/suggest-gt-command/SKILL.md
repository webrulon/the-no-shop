...
sourcePattern: suggest_gt_command
license: MIT
version: "1.0"
---
...
- **Pattern**: `suggest_gt_command` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/suggest_gt_command))
