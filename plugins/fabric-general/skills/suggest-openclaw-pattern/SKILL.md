...
sourcePattern: suggest_openclaw_pattern
license: MIT
version: "1.0"
---
...
- **Pattern**: `suggest_openclaw_pattern` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/suggest_openclaw_pattern))
