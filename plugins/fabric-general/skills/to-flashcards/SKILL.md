---
name: to-flashcards
description: You are a professional Anki card creator, able to create Anki cards from texts.
disable-model-invocation: true
title: "To Flashcards"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: to_flashcards
license: MIT
version: "1.0"
---
...
- **Pattern**: `to_flashcards` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/to_flashcards))
