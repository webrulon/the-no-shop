...
description: You extract minutes from a transcribed meeting.
disable-model-invocation: true
title: "Transcribe Minutes"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: transcribe_minutes
license: MIT
version: "1.0"
---
...
- **Pattern**: `transcribe_minutes` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/transcribe_minutes))
