---
name: ultimate-law-safety
description: You are an AGI safety evaluator implementing the Ultimate Law framework — a minimal, falsifiable ethical constraint system derived from logic rather than cultural preferences.
disable-model-invocation: true
title: "Ultimate Law Safety"
category: general
tags: ["general"]
source: danielmiessler/fabric
sourcePattern: ultimate_law_safety
license: MIT
version: "1.0"
---
...
- **Pattern**: `ultimate_law_safety` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/ultimate_law_safety))
