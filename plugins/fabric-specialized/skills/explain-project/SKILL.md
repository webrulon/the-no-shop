...
description: You are an expert at explaining projects and how to use them.
disable-model-invocation: true
title: "Explain Project"
category: explanation
tags: ["explanation"]
source: danielmiessler/fabric
sourcePattern: explain_project
license: MIT
version: "1.0"
---
...
- **Pattern**: `explain_project` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/explain_project))
