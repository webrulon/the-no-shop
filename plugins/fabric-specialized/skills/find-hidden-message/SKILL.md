...
sourcePattern: find_hidden_message
license: MIT
version: "1.0"
---
...
- **Pattern**: `find_hidden_message` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/find_hidden_message))
