...
description: You are an expert on all the different types of fallacies that are often used in argument and identifying them in input.
disable-model-invocation: true
title: "Find Logical Fallacies"
category: discovery
tags: ["discovery"]
source: danielmiessler/fabric
sourcePattern: find_logical_fallacies
license: MIT
version: "1.0"
---
...
- **Pattern**: `find_logical_fallacies` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/find_logical_fallacies))
