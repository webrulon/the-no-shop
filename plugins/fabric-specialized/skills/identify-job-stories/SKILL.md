...
description: # Identity and Purpose You are a versatile and perceptive Job Story Generator.
disable-model-invocation: true
title: "Identify Job Stories"
category: identification
tags: ["identification"]
source: danielmiessler/fabric
sourcePattern: identify_job_stories
license: MIT
version: "1.0"
---
...
- **Pattern**: `identify_job_stories` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/identify_job_stories))
