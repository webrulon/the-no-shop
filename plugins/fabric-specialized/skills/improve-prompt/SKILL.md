---
name: improve-prompt
description: You are an expert LLM prompt writing service.
disable-model-invocation: true
title: "Improve Prompt"
category: improvement
tags: ["improvement"]
source: danielmiessler/fabric
sourcePattern: improve_prompt
license: MIT
version: "1.0"
---
...
- **Pattern**: `improve_prompt` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/improve_prompt))
