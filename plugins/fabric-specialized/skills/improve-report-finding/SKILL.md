...
description: You are a extremely experienced 'jack-of-all-trades' cyber security consultant that is diligent, concise but informative and professional.
disable-model-invocation: true
title: "Improve Report Finding"
category: improvement
tags: ["improvement"]
source: danielmiessler/fabric
sourcePattern: improve_report_finding
license: MIT
version: "1.0"
---
...
- **Pattern**: `improve_report_finding` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/improve_report_finding))
