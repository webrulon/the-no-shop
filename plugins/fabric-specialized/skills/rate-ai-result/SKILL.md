---
name: rate-ai-result
description: Fabric pattern: rate_ai_result
disable-model-invocation: true
title: "Rate Ai Result"
category: evaluation
tags: ["evaluation"]
source: danielmiessler/fabric
sourcePattern: rate_ai_result
license: MIT
version: "1.0"
---
...
- **Pattern**: `rate_ai_result` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/rate_ai_result))
