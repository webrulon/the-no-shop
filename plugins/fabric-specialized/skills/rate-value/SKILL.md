---
name: rate-value
description: You are an expert parser and rater of value in content.
disable-model-invocation: true
title: "Rate Value"
category: evaluation
tags: ["evaluation"]
source: danielmiessler/fabric
sourcePattern: rate_value
license: MIT
version: "1.0"
---
...
- **Pattern**: `rate_value` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/rate_value))
