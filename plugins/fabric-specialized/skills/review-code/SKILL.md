---
name: review-code
description: Fabric pattern: review_code
disable-model-invocation: true
title: "Review Code"
category: evaluation
tags: ["evaluation"]
source: danielmiessler/fabric
sourcePattern: review_code
license: MIT
version: "1.0"
---
...
- **Pattern**: `review_code` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/review_code))
