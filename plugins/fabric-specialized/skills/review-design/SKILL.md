---
name: review-design
description: You are an expert solution architect.
disable-model-invocation: true
title: "Review Design"
category: evaluation
tags: ["evaluation"]
source: danielmiessler/fabric
sourcePattern: review_design
license: MIT
version: "1.0"
---
...
- **Pattern**: `review_design` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/review_design))
