...
description: Fabric pattern: summarize_debate
disable-model-invocation: true
title: "Summarize Debate"
category: summarization
tags: ["summarization"]
source: danielmiessler/fabric
sourcePattern: summarize_debate
license: MIT
version: "1.0"
---
...
- **Pattern**: `summarize_debate` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/summarize_debate))
