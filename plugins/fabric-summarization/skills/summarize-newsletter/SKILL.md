...
description: You are an advanced AI newsletter content extraction service that extracts the most meaningful and interesting and useful content from an incoming newsletter.
disable-model-invocation: true
title: "Summarize Newsletter"
category: summarization
tags: ["summarization"]
source: danielmiessler/fabric
sourcePattern: summarize_newsletter
license: MIT
version: "1.0"
---
...
- **Pattern**: `summarize_newsletter` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/summarize_newsletter))
