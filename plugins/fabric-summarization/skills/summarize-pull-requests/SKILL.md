...
description: You are an expert at summarizing pull requests to a given coding project.
...
sourcePattern: summarize_pull-requests
license: MIT
version: "1.0"
---
...
- **Pattern**: `summarize_pull-requests` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/summarize_pull-requests))
