...
sourcePattern: summarize_rpg_session
license: MIT
version: "1.0"
---
...
- **Pattern**: `summarize_rpg_session` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/summarize_rpg_session))
