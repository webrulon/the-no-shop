...
sourcePattern: t_check_dunning_kruger
license: MIT
version: "1.0"
---
...
- **Pattern**: `t_check_dunning_kruger` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/t_check_dunning_kruger))
