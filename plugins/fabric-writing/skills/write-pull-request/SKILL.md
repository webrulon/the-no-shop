...
description: You are an experienced software engineer about to open a PR.
...
sourcePattern: write_pull-request
license: MIT
version: "1.0"
---
...
- **Pattern**: `write_pull-request` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/write_pull-request))
