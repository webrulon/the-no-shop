...
description: You are an expert at writing Semgrep rules.
disable-model-invocation: true
allowed-tools: Bash(semgrep *)
title: "Write Semgrep Rule"
category: writing
tags: ["semgrep", "writing"]
source: danielmiessler/fabric
sourcePattern: write_semgrep_rule
license: MIT
version: "1.0"
---
...
- **Pattern**: `write_semgrep_rule` ([view original](https://github.com/danielmiessler/fabric/tree/main/patterns/write_semgrep_rule))
